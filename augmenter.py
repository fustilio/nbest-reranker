...
def augment(features, src_sents, input_nbest_path, output_nbest_path):
    ...
    sent_count = 0
    zipped_list = list(zip(input_nbest, src_sents))
    for group, src_sent in zipped_list:
        candidate_count = 0
        for item in group:
...
if __name__ == '__main__':
    ...
    L.print_args(args)
    augment(args.feature_string, args.source_path, args.input_nbest_path, args.output_nbest_path)
